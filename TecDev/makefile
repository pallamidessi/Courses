...
$(TARGET)_cairo: main_cairo.o grille_cairo.o Image.o compteur.o cairo_util.o
	$(CC) -o $@ $(OBJ)main_cairo.o $(OBJ)grille_cairo.o $(OBJ)Image.o $(OBJ)compteur.o $(OBJ)cairo_util.o $(LDFLAGS2)
