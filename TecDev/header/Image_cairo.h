 ...
 * \version    1.0
 * \date       4 mars 2012
 * \brief      header de Image_cairo.c
 *
 * \details    Contient les prototypes des fonctions relatives au chargement d'une image ppm en logigraphe pour la version cairo.
 *
 */
