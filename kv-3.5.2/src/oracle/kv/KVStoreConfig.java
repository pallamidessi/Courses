...
public class KVStoreConfig implements Serializable, Cloneable,
     ...
     */
    private static final int DEFAULT_MAX_CHECK_RETRIES = 10;
     ...
     */
    private static final int DEFAULT_CHECK_INTERVAL_MILLIS = 5000;
    ...
    public KVStoreConfig setMaxCheckRetries(int maxCheckRetries) {
        setMaxCheckRetriesVoid(maxCheckRetries);
        return this;
    }
