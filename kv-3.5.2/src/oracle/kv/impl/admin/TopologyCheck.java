...
public class TopologyCheck {
    ...
    private static final Map<RNLocationInput, RNRemedyFactory> RN_REMEDIES =
        new HashMap<RNLocationInput, RNRemedyFactory>();
    static {
        initRNRemedies();
    }
     ...
     * @param newMountPoint if not null, provides the new mount point for the
     * RN if fixing things up for an RN that has been partially relocated
    ...
    public Remedy checkRNLocation(Admin admin,
         ...
         * OkayRemedy.FACTORY.
         */
        RNRemedyFactory remedyFactory = RN_REMEDIES.get(remedyKey);
   ...
   /**
    ...
    public boolean applyRemedy(Remedy remedy, AbstractPlan plan) {
        ...
        if (!remedy.isOkay() && !remedy.canFix()) {
            ...
            logger.info(CHECK + " did not act upon " + this);
    ...
    private boolean repairAdminParams(UpdateAdminParamsRemedy remedy,
        ...
        try {
            ...
            logger.info(CHECK + " could not update admin params: " + e);
            return false;
        }
    }
    ...
    private boolean repairRNParams(UpdateRNParamsRemedy remedy,
        ...
        try {
            ...
            logger.info(CHECK + " could not update RN params: " + e);
            return false;
        }
    }
    ...
    static class RevertRNRemedy extends RNRemedy {
        ...
        void toStringInternal(StringBuilder builder) {
            ...
            if (newMountPoint != null) {
                builder.append(", newMountPoint=").append(newMountPoint);
            }
        }
        StorageNodeId getOldSNId() { return oldSNId; }
        String getNewMountPoint() { return newMountPoint; }
    }
