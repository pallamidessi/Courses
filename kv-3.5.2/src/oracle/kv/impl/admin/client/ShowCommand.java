        ...
        public String execute(String[] args, Shell shell)
            ...
            try {
                ...
                for (ParameterMap map : admins) {
                    ...
                    sb.append(", HTTP port ").append(params.getHttpPort());
                    ...
                    if (adminStatus == null) {
                        ...
                        final State state = adminStatus.getReplicationState();
                        if (state != null) {
    ...
    private static final class ShowPlans extends SubCommand {
            ...
            for (int i = 1; i < args.length; i++) {
                ...
                if ("-id".equals(arg)) {
                    ...
                    try {
                        ...
                        throw new ShellUsageException(
                            "Invalid number of plans: " + args[i], this);
                    }
        ...
        private String showSinglePlan(Shell shell, String[] args,
            ...
            try {
                ...
                final String planStatus = cs.getPlanStatus(planId,
                                                           options,
                                                           shell.getJson());
                if (shell.getJson()) {
    ...
    private static final class ShowVersions extends SubCommand {
        ...
        public String execute(String[] args, Shell shell)
            ...
            try{
                ...
                StorageNodeAgentAPI sna = RegistryUtils.getStorageNodeAgent(
        ...
        protected String getCommandDescription() {
            return
                "Display client and conneted server version information. "
