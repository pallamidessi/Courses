...
public class CommandServiceImpl
    ...
    public Plan getPlanById(final int planId,
        ...
        return aservice.getFaultHandler().execute
            ...
            public Plan execute() {
                requireConfigured();
                /*
                 * Don't talk to pre-V5 client since they cannot recognize
                 * new plans introduced in V5.
                 */
                checkClientSupported(serialVersion, SerialVersion.V5);
   ...
   /**
        ...
        return aservice.getFaultHandler().execute
            ...
            public Integer execute() {
                ...
                return admin.getPlanner().createDeployAdminPlan
                    (planName, snid, httpPort, adminType);
            }
        });
    }
        ...
        return aservice.getFaultHandler().execute
            ...
            public Integer execute() {
                ...
                checkPermission(aservice, new TableContext("Drop table",
                                                           ...
                                                           privsToCheck));
                return admin.getPlanner().
                    createRemoveTablePlan(planName, tableName, removeData);
            }
        });
    }
    ...
    public int createAddIndexPlan(final String planName,
        ...
        return aservice.getFaultHandler().execute
            ...
            public Integer execute() {
                ...
                return admin.getPlanner().
                    createAddIndexPlan(planName, indexName, tableName,
    ...
    public int createRemoveIndexPlan(final String planName,
        ...
        return aservice.getFaultHandler().execute
            ...
            public Integer execute() {
                ...
                return admin.getPlanner().
                    createRemoveIndexPlan(planName, indexName, tableName);
            }
        });
    }
    ...
    public void putMetadata(final Metadata<?> metadata,
        ...
        aservice.getFaultHandler().execute
            (new ProcessFaultHandler.SimpleProcedure() {
                    ...
                    public  void execute() {
                        requireConfigured();
                        admin.saveMetadata(metadata, null);
    ...
    public RetrievedEvents<LogRecord> getLogSince(long since,
        ...
        /*
         * Don't talk to pre-V5 client since they cannot recognize
         * security logging level introduced in V5.
         */
        checkClientSupported(serialVersion, SerialVersion.V5);
     ...
     */
    private void checkClientSupported(short clientSerialVersion,
        ...
        if (clientSerialVersion < requiredSerialVersion) {
            ...
            throw new AdminFaultException(
                new UnsupportedOperationException(msg), msg,
     ...
     * Only USRVIEW is required here because we want to allow all authenticated
     * users to be able to perform this operation, since it is required by
     * every operation that needs to locate the Http port of master admin node.
     */
    @SecureAutoMethod(privileges = { KVStorePrivilegeLabel.USRVIEW })
    ...
    private TableImpl getAndCheckTable(String tableName) {
        final TableMetadata tableMd =
            aservice.getAdmin().getMetadata(TableMetadata.class,
                                            MetadataType.TABLE);
        final TableImpl table = (tableMd == null) ?
                                null :
                                tableMd.getTable(tableName);
        if (table == null) {
            throw new IllegalCommandException(
