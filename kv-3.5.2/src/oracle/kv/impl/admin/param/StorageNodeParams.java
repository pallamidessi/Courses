...
public class StorageNodeParams implements ParamsWithMap, Serializable {
    ...
    public static RNHeapAndCacheSize
        ...
        if (policyHeapBytes != 0) {
            ...
            final long maxHeapBytes = (maxHeapMB != 0) ?
                maxHeapMB << 20 : MAX_COMPRESSED_OOPS_HEAP_SIZE;

            /* Finally apply the RN heap limit. */
            perRNHeap = Math.min(memoryForHeapBytes / divisor, maxHeapBytes);
        }
    ...
    public static class RNHeapAndCacheSize {
        ...
        private RNHeapAndCacheSize(long heapBytes, long cacheBytes) {
