...
public final class CommandServiceAPI extends RemoteAPI {
    ...
    public int createDeployAdminPlan(String planName,
        ...
        return createDeployAdminPlan(planName, snid, httpPort,
                                     AdminType.PRIMARY);
    ...
    public int createDeployAdminPlan(String planName,
        ...
        if (getSerialVersion() < ADMIN_TYPE_SERIAL_VERSION) {
            ...
            final int result = proxyRemote.createDeployAdminPlan(
                planName, snid, httpPort, NULL_CTX, getSerialVersion());
            return result;
        }
   ...
   /**
    ...
    /**
     * Returns the address for the HTTP service for the master admin, or null
     * if there is no current master.
     *
     * @return the HTTP address or null
     * @throws RemoteException if a communication problem occurs
     */
