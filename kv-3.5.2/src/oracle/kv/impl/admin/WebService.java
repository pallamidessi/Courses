...
public class WebService {
    ...
    public WebService(CommandServiceAPI aservice,
                      AdminServiceParams params,
                      Logger logger) {
    ...
    public void start() throws Exception {
        ...
        final String rootDirPath = snParams.getRootDirPath();
        final StorageNodeId storageNodeId = snParams.getStorageNodeId();
        final AdminId adminId = params.getAdminParams().getAdminId();
        ...
        File webAppDir = FileNames.getAdminWebAppDir(rootDirPath,
                                                     kvstoreName,
                                                     null,
                                                     storageNodeId,
                                                     adminId);
        FileNames.removeDir(webAppDir);
        FileNames.makeDir(webAppDir);
        wac.setTempDirectory(webAppDir);
