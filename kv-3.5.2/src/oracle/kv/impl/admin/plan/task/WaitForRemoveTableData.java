...
public class WaitForRemoveTableData extends AbstractTask {
     ...
     * will stop.
     */
    public WaitForRemoveTableData(MetadataPlan<TableMetadata> plan,
                                  RepGroupId groupId,
                                  String tableName) {
        this.plan = plan;
    ...
    private NextJob waitForRemoveTableData(int taskId,
        ...
        try {
            ...
            plan.getLogger().log(Level.INFO,
                                 "Wait for remove table {0} data for {1}",
                                 new Object[] {tableName, groupId});
    ...
    private NextJob queryForDone(int taskId,
        ...
        try {
            ...
            final boolean done = masterRN.removeTableDataComplete(tableName);

            plan.getLogger().log(Level.INFO,    // TODO -info
                                 "Remove table {0} on {1} done={2}",
    ...
    public String toString() {
        return TablePlanGenerator.makeName("WaitForRemoveTableData",
                                           tableName, null);
    }
