...
public class MigratePartition extends AbstractTask {
    ...
    private RepNodeAdminAPI getTarget()
        ...
        RepNode targetMasterRN = collector.getMaster(targetRGId);
    ...
    private RepNodeAdminAPI getSource()
        ...
        Topology topology = admin.getCurrentTopology();
        PingCollector collector = new PingCollector(topology);
        RepNode masterRN = collector.getMaster(sourceRGId);
        if (masterRN == null) {
            return null;
        }
    ...
    private NextJob cancelMigration(int taskId,
        ...
        try {
            ...
            Topology topology = admin.getCurrentTopology();
            PingCollector collector = new PingCollector(topology);
            RepNode sourceMasterRN = collector.getMaster(sourceRGId);
