...
public class DeployTopoPlan extends AbstractPlan {
     ...
     */
    public static DeployTopoPlan create(AtomicInteger idGen,
                                        String planName,
                                        Planner planner,
                                        Topology current,
                                        TopologyCandidate candidate) {
        final DeployTopoPlan plan =
            new DeployTopoPlan(idGen, planName, planner, current, candidate);
        plan.generateTasks(current, candidate);
        return plan;
    }

    /** Internal constructor */
    protected DeployTopoPlan(AtomicInteger idGen,
                             String planName,
                             Planner planner,
                             Topology current,
                             TopologyCandidate candidate) {
    ...
    /**
     * Generate the tasks for this plan, throwing an exception if the arguments
     * used to create the plan are illegal.  Call this method after
