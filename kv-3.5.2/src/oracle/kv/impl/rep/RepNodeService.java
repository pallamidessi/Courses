...
public class RepNodeService implements ConfigurableService {
     ...
     * doesn't hang
     */
    private static final long SHUTDOWN_TIMEOUT_MS = 10 * 1000;
    ...
    public void start(Topology topology) {
        ...
        try {
            ...
            KVStoreCreator creator = new KVStoreCreator(this, logger);

            /*
             * Starts the RepNodeSecurity, which relies on topology startup
             */
            rnSecurity.startup(creator);
            ...
            keyStatsCollector.startup(creator);
    ...
    public class KVStoreCreator {
        ...
        public KVStoreCreator(RepNodeService rnService,
                              Logger logger) {
            this.dispatcher = rnService.getRequestDispatcher();
