...
public class OperationsStatsTracker implements ParameterListener {
    ...
    public static class SummarizingStatsTracker extends StatsTracker<OpCode> {
        ...
        public LatencyStat getSingleOpsIntervalStat() {
            return singleOpsInterval;
        }

        public LatencyStat getSingleOpsCumulativeStat() {
            return singleOpsCumulative;
        }

        public LatencyStat getMultiOpsIntervalStat() {
            return multiOpsInterval;
        }

        public LatencyStat getMultiOpsCumulativeStat() {
