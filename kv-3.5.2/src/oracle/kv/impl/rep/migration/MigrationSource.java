...
class MigrationSource implements Runnable {
    ...
    /*
     * True if this is a transfer only stream. In this mode there is no need
     * persist transfer complete. Also in this mode, the VLSN is sent. The
     * mode is enabled when the target is TransferProtocol.TRANSFER_ONLY_TARGET.
     */
