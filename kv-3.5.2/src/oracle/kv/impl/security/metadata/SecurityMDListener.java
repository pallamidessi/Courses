 ...
 * services that want to be notified of security metadata change at runtime.
 */
public interface SecurityMDListener {

    /**
     * Notify listener of security metadata change.
     * 
     * @param mdChange Security metadata change
     */
