...
public class UserLoginHandler {
     ...
     *        if this is a forwarded login request.
     * @return a LoginResult
     * @throw AuthenticationFailureException if the old LoginCredentials are
     *        not valid
     */
    public LoginResult renewPasswordLogin(LoginCredentials oldCreds,
        ...
        try {
            ...
            if (passwordRenewer.renewPassword(userName,
                                              newPassword)) {
    ...
    private LoginResult loginInternal(LoginCredentials creds, String clientHost)
         ...
         final LoginToken loginToken = createLoginSession(subject, clientHost);
