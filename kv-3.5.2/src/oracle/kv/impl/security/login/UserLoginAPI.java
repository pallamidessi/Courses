...
public final class UserLoginAPI extends RemoteAPI {
    ...
    /**
     * Specifying password expiration is only supported starting with
     * version 7.
     */
    private static final short PASSWORD_EXPIRATION_SERIAL_VERSION =
        SerialVersion.V7;
