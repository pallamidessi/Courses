...
public class SecurityConfigCreator {
    ...
    public static class ParsedConfig {
        ...
        public void setUserExternalAuth(String externalAuthVal) {
            /*
             * Although we will support multiple authentication methods,
             * but currently only kerberos is supported
             */
    ...
    private boolean resolveKerberosAuth() {
        ...
        ioHelper.println("Unable to locate Kerberos authenticator class, " +
