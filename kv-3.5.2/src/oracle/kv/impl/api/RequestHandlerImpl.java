    ...
    private Response executeInternal(Request request) {
        ...
        do {
            ...
            try {
                ...
                /*
                 * Perf hack to bypass Transaction's expensive duration based
                 * interface for setTxnTimeout.
                 */
                ...
                AccessCheckUtils.logSecurityError(
                    ue, "API request: " + request.getOperation(), logger);
                throw ue;
                 ...
                 */
                if (fe instanceof MetadataNotFoundException &&
                    request.getSerialVersion() < SerialVersion.V8) {
                    fe = new FaultException(fe.getMessage(), true);
                }
                /*
