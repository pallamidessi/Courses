...
public class RequestDispatcherImpl implements RequestDispatcher {
     ...
     */
    private final WaitableCounter activeRequestCount = new WaitableCounter();
    ...
    public Response execute(Request request,
        ...
        do { /* Retry until timeout. */
            ...
            try {
            	...
            	/*
            	 * Eclipse erroneously warns that the value of "target" may be
            	 * null at this point, which cannot be true. Assigning target
            	 * to a different local variable in this annoying but harmless
            	 * way makes the warning go away.
            	 */
            	final RepNodeState targetProxy = target;
                ...
                excludeRNs = excludeRN(excludeRNs, targetProxy);
            }
